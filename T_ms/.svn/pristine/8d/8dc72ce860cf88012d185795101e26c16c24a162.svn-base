...
<html lang="en">
    ...
    function formatOper(val,row,index){
    	if(row.state == '已启用'){
        return '<a href="#"  style="text-decoration:none;"  onclick="editState('+index+')">充值</a>'; 
   ...
   function loadData(date,userName,phonenum){
		$('#user').datagrid({
			...
			columns:[[
				...
				{field:'credits',title:'积分',width:100},
    ...
    <div id="tb" style="padding:5px;height:auto">
		<div>
			注册日期: <input id ="date" name = "date" class="easyui-datebox" style="width:150px">
	...
	<div id="dlg" class="easyui-dialog" title="账户充值" style="display: none;overflow: hidden; width:400px;height:400px;padding:10px"
		...
		<form id="rechargeTable" enctype="multipart/form-data" method="post">
			<table>
				...
				<tr><td>充值金额（￥）：&nbsp;</td><td><input id="remoney_rechar" name="remoney_rechar" class='easyui-textbox' data-options="prompt:'要充值的金额',missingMessage:'此处不能为空',required:true,validType:['currency','length[1,5]']"  style="width:150px"></td></tr>
			</table>
		</form>
	</div>
