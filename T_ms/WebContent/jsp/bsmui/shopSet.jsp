...
<html lang="en">
    ...
    function update(){
    	 ...
    	 if(row){
    		 ...
    		 $('#update_describe').textbox('setValue',row.descri);
   ...
   function loadData(date,shopName,userid){
	...
	<div id="dlg-buttons">
		...
		<!-- dialog 修改对话框 -->
	<div id="update-dlg" class="easyui-dialog" title="添加店铺" style="display: none;overflow: hidden; width:500px;height:400px;padding:10px"
			data-options="
				iconCls: 'icon-save',
			...
			">
			   <!--closed : true 解决加载时对话框弹出 -->
		<form id="updateTable" enctype="multipart/form-data" method="post">
	<!-- 		<table>
	 ...
	 -->			
			<table>
				<tr><td>店铺ID:</td><td><input id = "update_id" name ="update_id"  style="width:250px"></td></tr>
				<tr><td>店家名称：</td><td><input id="update_shopName" name="update_shopName"  class='easyui-textbox' data-options="prompt:'请输入店名',missingMessage:'此处不能为空',invalidMessage:'长度为3~10之间',required:true,validType:'length[3,15]'" style="width:250px"></td></tr>
				<tr><td>地址：&nbsp;</td><td><input id="update_address"  name="update_address"class='easyui-textbox' data-options="prompt:'地址',missingMessage:'此处不能为空',required:true,validType:'length[1,25]'" style="width:250px"></td></tr>
				<tr><td>电话：&nbsp;</td><td><input id="update_phonenum" name="update_phonenum" class='easyui-textbox' data-options="prompt:'电话',missingMessage:'此处不能为空',required:true,validType:'mobile'"  style="width:250px"></td></tr>
				<tr><td>原图片:</td><td><input id = "pictureurl" disabled="true" style="width:250px"></td></tr>
				<tr><td>添加图片：</td><td><input id="update_pictureurl"  name="update_pictureurl" class='easyui-filebox' data-options="missingMessage:'此处不能为空',required:true"  style="width:250px;height:30px"></td></tr>
				<tr><td>描述：&nbsp;&nbsp;&nbsp;&nbsp;</td><td><input id="update_describe" name="update_describe" type="message" class='easyui-textbox' data-options="multiline:true,prompt:'描述',missingMessage:'此处不能为空',required:true,validType:'length[1,80]'" style="width:250px;height:60px"></td></tr>
			</table>
		</form>
	</div>

	<div id="update-dlg-buttons">
		<a href="javascript:void(0)" class="easyui-linkbutton" onclick="shopUpdate()">提交</a>
		<a href="javascript:void(0)" class="easyui-linkbutton" onclick="javascript:$('#update-dlg').dialog('close')">取消</a>
	</div>
	</body>
	<script type="text/javascript">
		function shopUpdate(){
			 var form = new FormData(document.getElementById("updateTable"));
			 $.ajax({
				   type:"post", //请求方式
				   url:"../../shop/shopUpdate.do", //发送请求地址
				   data:form, //发送给数据库的数据     
				   dataType : "json",
			       contentType: false,    
			       processData: false,
