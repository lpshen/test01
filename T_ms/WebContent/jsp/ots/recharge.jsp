...
<div id="main">
	...
	<h2>充值规则</h2><hr>
	<ol>
		<li>亲，您可以来我们三河酒家进行充值&nbsp;<a href="${pageContext.request.contextPath}/shop/shopShow.do">店家信息</a></li>
		<li>亲，您可以通过微信充值哟!&nbsp;<a href="${pageContext.request.contextPath}/jsp/ots/weChatPay.jsp">现在就去</a></li>
	</ol>
	<!-- 主要部分结束 -->
	</div>
	<div id="right">
